<?= $this->render('_head') ?><!--引入公共头部-->
	<body>
			...
			<form class="register">
				...
				<div class="li-box">
					...
					<input id="username" name="username" class="col-1" type="text" class="user-input" maxlength="30" placeholder="请输入用户名">
				</div>
				<div class="li-box">
                ...
                <div class="li-box">
				 ...
				 <div class="li-box">
					<span class="col-1">邀请码:</span>
					<input id="inivde" name="inivde" class="col-1" type="text" class="user-input" maxlength="30" placeholder="请再次输入密码">
				</div>
				<div class="li-box pr">
			 ...
			 <p style="margin:.15rem .15rem ; font-size: .13rem;" class="col-2"><input id="agreement" name="agreement" style="vertical-align: middle;" type="checkbox" checked />我已阅读并同意<a href="/service/yd.html" class="col-up">《期管家服务协议》</a></p>
	...
	<script type="text/javascript">
        $(function () {
			...
			// if(xx==null)
			// {$('#inivde').val(inivde_code).attr("disabled","disabled");}
			// else{
				$('#inivde').val(xx);
